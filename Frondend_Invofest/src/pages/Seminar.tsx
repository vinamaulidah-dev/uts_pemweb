export default function Seminar() {
  ...
  const infoPelaksanaan = [
    { icon: "📅", label: "Kamis, 27 November 2025" },
    { icon: "⏰", label: "08.00 WIB - 12.00 WIB" },
    { icon: "📍", label: "Aula Gedung C" },
    { icon: "🏫", label: "Kampus 1 (Mataram) Universitas Harkat Negeri" },
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-16 py-20 max-w-6xl mx-auto">
        <div className="max-w-lg">
          ...
          <p className="text-gray-600 leading-relaxed mb-8">
            ...
            sistem di mana manusia dan AI bekerja sebagai mitra yang sinergis. Yang bertujuan
            mengubah paradigma dari persaingan menjadi kolaborasi, serta meningkatkan
      ...
      {/* ── Tentang IT Seminar (pink wave bg) ── */}
      <section className="relative bg-[#fce8ef] py-20 px-8 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto py-8">
          ...
          <p className="text-gray-600 leading-relaxed text-base">
            Seminar bertajuk "Human-AI Integration: Merancang Arsitektur Kolaboratif." Di
            tengah pesatnya kemajuan kecerdasan buatan (AI), narasi yang sering muncul adalah
            tentang persaingan antara manusia dan mesin. Kekhawatiran akan penggantian peran
            manusia oleh teknologi cerdas menjadi diskusi utama di berbagai sektor. Namun,
            bagaimana jika kita mengubah paradigma tersebut? Seminar Nasional Teknologi
            Informasi ini hadir untuk menjawab tantangan itu dengan mengangkat tema
            "Human-AI Integration: Merancang Arsitektur Kolaboratif, Bukan Kompetitif." Kami
            bertujuan untuk menggeser fokus dari ketakutan akan kompetisi menjadi eksplorasi
            peluang kolaborasi. Seminar ini akan mengupas tuntas bagaimana kita dapat
            merancang sistem, etika, dan lingkungan kerja di mana AI berfungsi sebagai mitra
            yang memperkuat kecerdasan, kreativitas, dan produktivitas manusia—bukan sebagai
            pengganti.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-8 max-w-5xl mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {speakers.map((s) => (
            <div
              key={s.name}
              className="border border-gray-200 rounded-xl pt-16 pb-6 px-6 relative w-52 shadow-sm"
            >
      ...
      {/* ── Pelaksanaan IT Seminar (pink wave bg) ── */}
      <section className="relative bg-[#fce8ef] py-20 px-8 text-center overflow-hidden">
        <div className="absolute top-0 left-0 w-full overflow-hidden leading-none">
          <svg viewBox="0 0 1440 60" xmlns="http://www.w3.org/2000/svg" className="w-full">
            <path d="M0,30 C360,60 1080,0 1440,30 L1440,0 L0,0 Z" fill="white" />
